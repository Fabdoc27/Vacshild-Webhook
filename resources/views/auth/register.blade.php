<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="nid" class="block w-full mt-1" type="number" name="nid" :value="old('nid')" required autofocus autocomplete="nid" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="phone" class="block w-full mt-1" type="number" name="phone" :value="old('phone')" required autofocus autocomplete="phone" />
